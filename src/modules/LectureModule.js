...
export const { lecture:
    ...
    { getSubjectInfo, getLectureInfo, getMylecture, getAttendanceListInfo, patchStdattendanceModify, getNewAttendancelistInfo, getLectureCount,getLecnameMylecture,getMylectureCerti ,getSearchName, patchLecPlan} } = createActions({
