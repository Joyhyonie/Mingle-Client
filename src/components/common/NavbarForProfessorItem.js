...
function NavbarForProfessorItem ({ title, index, list, active, activeIndex, setActiveIndex }) {
    ...
    const linkHandler = (e, index) => {
        ...
        switch (list[index]){
            ...
            case '출결 및 성적관리' : return navigate('/lecture-student-prof');
            case '강의 개설' : return navigate('/lecture-regist-prof');
        }
    }
...
export default NavbarForProfessorItem;