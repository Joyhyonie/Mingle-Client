...
function AcademicCalenderInfo ({dateInAcCal}) {
    ...
    /* (임시용)학사일정명이 23자 이상일 경우 그 뒤는 ...으로 화면에 노출되게끔 하기 위한 테스트 */
        ...
        <>
            ...
            <div>
                { acScheduleDetailModal ?
                    (<AcScheduleDetailModal setAcScheduleDetailModal={setAcScheduleDetailModal}/>) : null
                }
            </div>
                ...
                <div className={ MainCSS.ScheduleInfoBox }>
                    ...
                    <div className={ MainCSS.academicItemList }>
                        <div className={ MainCSS.academicItemBox }>
                            ...
                            <p
                                onClick={ () => setAcScheduleDetailModal(true) }
                            >
